...
class LoadData < ActiveRecord::Migration[4.2]
  def up
    ...
    photo1 = Photo.new(:date_time => "2012-08-30 10:44:23",
                       :file_name => "https://userimages-project-aws.s3.ap-south-1.amazonaws.com/ouster.jpg")
    photo1.user = jo
    photo1.save(:validate => false)

    photo2 = Photo.new(:date_time => "2009-09-13 20:00:00",
                       :file_name => "https://userimages-project-aws.s3.ap-south-1.amazonaws.com/bieber1.jpg")
    photo2.user = jb
    photo2.save(:validate => false)
    photo3 = Photo.new(:date_time => "2009-09-13 20:05:03",
                       :file_name => "https://userimages-project-aws.s3.ap-south-1.amazonaws.com/bieber2.jpg")
    photo3.user = jb
    photo3.save(:validate => false)

    photo4 = Photo.new(:date_time => "2013-11-18 18:02:00",
                       :file_name => "https://userimages-project-aws.s3.ap-south-1.amazonaws.com/hilton1.jpg")
    photo4.user = ph
    photo4.save(:validate => false)
    photo5 = Photo.new(:date_time => "2013-09-20 17:30:00",
                       :file_name => "https://userimages-project-aws.s3.ap-south-1.amazonaws.com/hilton2.jpg")
    photo5.user = ph
    photo5.save(:validate => false)

    photo6 = Photo.new(:date_time => "2009-07-10 16:02:49",
                       :file_name => "https://userimages-project-aws.s3.ap-south-1.amazonaws.com/obama1.jpg")
    photo6.user = bo
    photo6.save(:validate => false)
    photo7 = Photo.new(:date_time => "2010-03-18 23:48:00",
                       :file_name => "https://userimages-project-aws.s3.ap-south-1.amazonaws.com/obama2.jpg")
    photo7.user = bo
    photo7.save(:validate => false)
    photo8 = Photo.new(:date_time => "2010-08-30 14:26:00",
                       :file_name => "https://userimages-project-aws.s3.ap-south-1.amazonaws.com/obama3.jpg")
    photo8.user = bo
    photo8.save(:validate => false)

    photo9 = Photo.new(:date_time => "2013-12-03 09:02:00",
                       :file_name => "https://userimages-project-aws.s3.ap-south-1.amazonaws.com/megan1.jpg")
    photo9.user = mt
    photo9.save(:validate => false)
    photo10 = Photo.new(:date_time => "2013-12-03 09:03:00",
                        :file_name => "https://userimages-project-aws.s3.ap-south-1.amazonaws.com/megan2.jpg")
    photo10.user = mt
    photo10.save(:validate => false)


    photo11 = Photo.new(:date_time => "2013-09-04 09:16:32",
                        :file_name => "https://userimages-project-aws.s3.ap-south-1.amazonaws.com/santa1.jpg")
    photo11.user = sc
    photo11.save(:validate => false)

    photo12 = Photo.new(:date_time => "2013-10-16 17:12:28",
                        :file_name => "https://userimages-project-aws.s3.ap-south-1.amazonaws.com/obama4.jpg")
    photo12.user = bo
